...
app.get('/loan', function (req, res) {
	...
	res.sendFile( __dirname + "/" + "web1/input3.html",{ user: req.user } );
});
...
app.get('/userprofile', function (req, res) {
	...
	res.sendFile( __dirname + "/" + "web1/userprofile.html",{ user: req.user } );
});
...
app.get('/random', function (req, res) {
	...
	res.sendFile( __dirname + "/" + "web1/random.html",{ user: req.user } );
});
...
app.post('/mobile/newuserinsert', function (req, res) {
	//get data
    var data = {
...
//select newuserlist
app.get('/mobile/newuserlist', function (req, res) {
...
var server = app.listen(3306, function () {
  ...
  var host = 'ec2-34-204-12-59.compute-1.amazonaws.com';
